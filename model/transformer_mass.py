...
class MASSDecoder(TransformerDecoder):
    ...
    def extract_features(
        ...
        #print('self.img_Linear', self.img_Linear)
        ...
        if img_vec_tokens is not None:
            ...
            #img_vec_tokens_linear_tanh = torch.tanh(img_vec_tokens_linear)
        ...
        #print('img_vec_tokens_linear', img_vec_tokens_linear.shape)
        #print('decoder img_vec_tokens_linear', img_vec_tokens_linear.shape)
        #print('decoder img_vec_tokens_linear', img_vec_tokens_linear)
        # embed tokens and positions
        #print('prev_output_tokens', prev_output_tokens.shape)
        #print('x_embed', x_embed.shape)
        #print('decoder x_embed', x_embed.shape)
        #print('decoder x_embed', x_embed)
        #print('decoder x_embed', x_embed.shape)
        #print('decoder x_embed', x_embed)
        #print(ee)
        ...
        for idx, layer in enumerate(self.layers):
            ...
            if layer_attn is not None:
                ...
                print('x', x.shape)
                print('layer_attn', layer_attn.shape)
                print(eee)
            """
        ...
        #print('inner_states', inner_states)
        #print(eee)
